...
if is_finded("xray") or is_finded("v2ray") then
	o:value("xray", translate("V2Ray/XRay"))
end
...
o = s:option(ListValue, "xray_protocol", translate("V2Ray/XRay protocol"))
...
o.default = "0"
o:depends("type", "socks5")
o:depends({type = "xray", xray_protocol = "http"})
o:depends({type = "xray", xray_protocol = "socks"})

o = s:option(Value, "username", translate("Username"))
o.rmempty = true
o:depends("type", "naiveproxy")
o:depends({type = "socks5", auth_enable = true})
o:depends({type = "xray", xray_protocol = "http", auth_enable = true})
o:depends({type = "xray", xray_protocol = "socks", auth_enable = true})
...
o:depends({type = "socks5", auth_enable = true})
o:depends({type = "xray", xray_protocol = "http", auth_enable = true})
o:depends({type = "xray", xray_protocol = "socks", socks_ver = "5", auth_enable = true})
o:depends({type = "xray", xray_protocol = "shadowsocks"})
o:depends({type = "xray", xray_protocol = "trojan"})
...
o:depends({type = "hysteria", flag_quicparam = "1"})
o:depends({type = "xray", xray_protocol = "wireguard"})
o.rmempty = true
o.datatype = "uinteger"
o.default = "10"
...
if is_finded("xray") or is_finded("xray") then
...
o.default = 16
o.rmempty = true
o:depends({type = "xray", xray_protocol = "vmess"})
...
o.default = uuid
o:depends({type = "xray", xray_protocol = "vmess"})
o:depends({type = "xray", xray_protocol = "vless"})
...
o.rmempty = true
o.default = "0"
o:depends({type = "xray", xray_protocol = "vless", reality = false})
o:depends({type = "xray", xray_protocol = "vmess", reality = false})
o:depends({type = "xray", xray_protocol = "trojan", reality = false})
o:depends({type = "xray", xray_protocol = "shadowsocks", reality = false})
o:depends({type = "xray", xray_protocol = "socks", socks_ver = "5", reality = false})
o:depends({type = "xray", xray_protocol = "http", reality = false})
o:depends("type", "trojan")
o:depends("type", "hysteria")
...
if is_finded("xray") then
	...
	o.rmempty = true
	o.default = "0"
	o:depends({type = "xray", xray_protocol = "vless", tls = false})

	o = s:option(Value, "reality_publickey", translate("Public key"))
	o.rmempty = true
	o:depends({type = "xray", xray_protocol = "vless", reality = true})
	...
	o.rmempty = true
	o:depends({type = "xray", xray_protocol = "vless", transport = "tcp", tls = true})
	o:depends({type = "xray", xray_protocol = "vless", transport = "tcp", reality = true})
	...
	o:depends({type = "xray", tls = true})
	o:depends({type = "xray", reality = true})
end
...
o:depends({type = "xray", xray_protocol = "vmess", tls = true, insecure = false})
o:depends({type = "xray", xray_protocol = "vless", tls = true, insecure = false})
